...
abstract class $CompanyModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String description, String hexColor});
}
...
class _$CompanyModelImpl implements _CompanyModel {
  ...
  @override
  String toString() {
    return 'CompanyModel(id: $id, name: $name, description: $description, hexColor: $hexColor)';
  }
...
abstract class _CompanyModel implements CompanyModel {
  factory _CompanyModel(
      ...
      required final String hexColor}) = _$CompanyModelImpl;
